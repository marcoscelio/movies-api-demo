...
const MoviesResolver_1 = require("../users/resolvers/MoviesResolver");
...
MoviesModule = __decorate([
    common_1.Module({
        ...
        providers: [users_service_1.UsersService, movies_service_1.MoviesService, MoviesResolver_1.MoviesResolver, auth_service_1.AuthService],
        controllers: [],
